...
public class ArraysUtility {
    ...
    //return the maximum number of integer array
    public static int maxNumber(int[] numbers){
        Arrays.sort(numbers);
        return numbers[numbers.length-1];
    }

    //return the maximum number of double array
    ...
    //return the minimum number of int array
    public static int minNumber(int[] numbers){
        Arrays.sort(numbers);
        return numbers[0];
    }

    //return the minimum number of double array
    ...
    //removes the elements from the array and return the new array in result
    ...
    //reverse the given arrays and returns a new array
    ...
    //removes the duplicates from the given arrays, returns the new array
